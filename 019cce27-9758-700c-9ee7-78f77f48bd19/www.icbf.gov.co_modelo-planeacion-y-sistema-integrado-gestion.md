---
url: "https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion"
title: "Modelo Planeación y Sistema Integrado Gestión | Portal ICBF - Instituto Colombiano de Bienestar Familiar ICBF"
---

[![clic para ir a GOVCO](https://www.icbf.gov.co/sites/default/files/logo_header.png)](https://www.gov.co/)

[![ícono de Accesibilidad](https://www.icbf.gov.co/sites/default/files/icon-top_15.png)Accesibilidad](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#blocks-links-acc "Haz clic para mostrar las opciones de Accesibilidad")
...
[![icono tamaño](https://www.icbf.gov.co/sites/default/files/icon-access_01.png)](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#blocks-links-acc "Clic para mostrar las opciones de Accesibilidad")**Tamaño de Texto**

- [85%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [100%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [125%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [150%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [175%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [200%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)

![icono interlinea](https://www.icbf.gov.co/sites/default/files/icon-access_02.png)**Interlineado**

- [0.5](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [1](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [1.5](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [2](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [2.5](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)

![icono espaciado](https://www.icbf.gov.co/sites/default/files/icon-access_03.png)**Espaciado**

- [90%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [100%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [150%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [200%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [250%](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)

![icono fuente](https://www.icbf.gov.co/sites/default/files/icon-access_04.png)**Fuente**

- [Arial](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [Sans](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [APHont](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [Times](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)

![icono contraste](https://www.icbf.gov.co/sites/default/files/icon-access_05.png)**Contraste**

- [Fondo negro texto blanco](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [Fondo negro texto amarillo](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [Fondo negro texto verde](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
- [Fondo blanco texto negro](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)

[Restaurar valores por defecto](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion#)
...
2. Modelo Planeación y Sistema Integrado Gestión


Previous

![ícono decorativo dimensión](https://www.icbf.gov.co/sites/default/files/mpg-icons_03.png)

Control Interno

![ícono decorativo dimensión](https://www.icbf.gov.co/sites/default/files/icono-dimensiones_02.png)

Talento Humano

![ícono decorativo dimensión](https://www.icbf.gov.co/sites/default/files/icono-dimensiones_07.png)

Direccionamiento Estrategico y Planeación

![ícono decorativo dimensión](https://www.icbf.gov.co/sites/default/files/icono-dimensiones_03.png)

Gestión con Valores para el Resultado

![ícono decorativo dimensión](https://www.icbf.gov.co/sites/default/files/icono-dimensiones_06.png)

Evaluación de Resultados

![ícono decorativo dimensión](https://www.icbf.gov.co/sites/default/files/icono-dimensiones_05.png)

Información y Comunicación

![ícono decorativo dimensión](https://www.icbf.gov.co/sites/default/files/icono-dimensiones_04.png)
...
![](https://www.icbf.gov.co/sites/default/files/modelo-de-planeacion-y-control-de-gestion-a6.png?fid=199017)

Previous

![mascota eje sgst](https://www.icbf.gov.co/sites/default/files/sige-mascotas_03.png)Seguridad y Salud en el Trabajo

![mascota eje ambiental](https://www.icbf.gov.co/sites/default/files/sige-mascotas_02.png)Ambiental

![mascota eje calidad](https://www.icbf.gov.co/sites/default/files/sige-mascotas_01.png)Calidad

![mascota eje seguridad](https://www.icbf.gov.co/sites/default/files/sige-mascotas_04.png)Seguridad de la Información
...
|     |     |
| --- | --- |
| [Resolución N° 0353 de 2023](https://www.icbf.gov.co/system/files/0353_-_reglamenta_el_tramite_y_plazo_para_la_publicacion_de_los_proyectos_contemplados_en_el_decreto_1081-15_0.pdf "0353_-_reglamenta_el_tramite_y_plazo_para_la_publicacion_de_los_proyectos_contemplados_en_el_decreto_1081-15.pdf") |  |
| [Resolución 8650 de 10 nov 2021 - Integra y Reglamenta CIGD Subcomité de Arq. Emp y la Mesa Técnica de SGIM en el ICBF](https://www.icbf.gov.co/system/files/resolucion_8650_de_10_nov_2021_-_integra_y_reglamenta_cigd_subcomite_de_arq._emp_y_la_mesa_tecnica_de_sgim_en_el_icbf_2.pdf "resolucion_8650_de_10_nov_2021_-_integra_y_reglamenta_cigd_subcomite_de_arq._emp_y_la_mesa_tecnica_de_sgim_en_el_icbf.pdf") |  |
| [Resolucion 6659 de Dic 2020- Modifica Modelo de Planeación y Sistema Integrado de Gestión](https://www.icbf.gov.co/system/files/resolucion_6659_de_dic_2020-_modifica_modelo_de_planeacion_y_sistema_integrado_de_gestion_1.pdf "resolucion_6659_de_dic_2020-_modifica_modelo_de_planeacion_y_sistema_integrado_de_gestion.pdf") |  |
| [Resolución 6659 de Dic 2020-Modifica Modelo de Planeación y el Sistema Integrado de Gestión](https://www.icbf.gov.co/system/files/resolucion_6659_de_dic_2020-_modifica_modelo_de_planeacion_y_sistema_integrado_de_gestion.pdf "resolucion_6659_de_dic_2020-_modifica_modelo_de_planeacion_y_sistema_integrado_de_gestion.pdf") |  |
| [Resolución 11980 Dic 2019 Adopta Modelos de Planeación y Sistema Integrado de Gestión](https://www.icbf.gov.co/system/files/resolucion_11980_de_dic_de_2019_-_adopta_modelo_de_planeacion_y_sistema_integrado_de_gestion_del_icbf_0.pdf "resolucion_11980_de_dic_de_2019_-_adopta_modelo_de_planeacion_y_sistema_integrado_de_gestion_del_icbf.pdf") |  |
| [2674 - Modifica Resolucion No. 6970-18 y se reestructura Subcomité de Gobierno de TI del ICBF](https://www.icbf.gov.co/sites/default/files/2674_-_modifica_resolucion_no._6970-18_y_se_reestructura_subcomite_de_gobierno_de_ti_del_icbf_4.pdf "2674_-_modifica_resolucion_no._6970-18_y_se_reestructura_subcomite_de_gobierno_de_ti_del_icbf.pdf") |  |

MIPG

De acuerdo con lo estipulado en el Decreto 1083 de 2015 modificado por Decreto 1499 de 2017 y el Manual Operativo del Modelo Integrado de Planeación y Gestión - MIPG definido por el Consejo para la Gestión y el Desempeño Institucional, el Modelo del ICBF integra siete (7) dimensiones, con sus objetivos

[Consultar MIPG](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion/modelo-integrado-de-planeacion-y-gestion "clic para consultar sección MIPG")

MISIONALIDAD

Herramienta gerencial enfocada a dirigir, planear, ejecutar, hacer seguimiento, evaluar y controlar la gestión de la entidad, promoviendo la mejora continua en cada uno de los procesos y fortaleciendo así el logro de la misión y los objetivos estratégicos de la entidad en el marco de las necesidades y expectativas de los niños, niñas, adolescentes y sus familias.

[Consultar Oferta Institucional](https://www.icbf.gov.co/portafolio-de-servicios-icbf "clic para consultar oferta institucional")

SIGE

Herramienta gerencial la cual tiene el propósito de promover y facilitar la mejora continua en la gestión del ICBF, orientada a lograr el impacto en los actuales y nuevos servicios que se prestan a la primera infancia, niñez y adolescentes y sus familias.

[Consultar SIGE](https://www.icbf.gov.co/modelo-planeacion-y-sistema-integrado-gestion/sistema-integrado-de-gestion "clic para consultar sección SIGE")

Contexto ICBF

El ICBF tiene como prioridad identificar, determinar y analizar las características o aspectos esenciales del entorno en el cual opera la entidad (contexto externo) y del ambiente en el cual busca alcanzar su misión, visión y objetivos estratégicos (contexto interno), entendiendo que la comprensión del contexto en general (aspectos DOFA y Partes Interesadas) aporta a la planeación estratégica, la gestión de riesgos, a la sostenibilidad y mejora continua del Instituto y a su vez contribuye a la implementación del Modelo Integrado de Planeación y Gestión – MIPG y sostenibilidad de las Normas de Gestión.

- **Anexo Contexto Externo e Interno ICBF v4 - A1.P22.DE** [Consultar Anexo](https://www.icbf.gov.co/system/files/procesos/a1.p22.de_anexo_contexto_externo_e_interno_icbf_2021.pdf "clic para consultar documento")

## Partes Interesadas

Previous

![](https://www.icbf.gov.co/sites/default/files/partes_interesadas0_10.png?fid=201186)

![](https://www.icbf.gov.co/sites/default/files/partes_interesadas0_01.png?fid=201179)

![](https://www.icbf.gov.co/sites/default/files/partes_interesadas0_03.png?fid=201180)

![](https://www.icbf.gov.co/sites/default/files/partes_interesadas0_04.png?fid=201181)

![](https://www.icbf.gov.co/sites/default/files/partes_interesadas0_05.png?fid=201182)

![](https://www.icbf.gov.co/sites/default/files/partes_interesadas0_07.png?fid=201183)

![](https://www.icbf.gov.co/sites/default/files/partes_interesadas0_08.png?fid=201184)

![](https://www.icbf.gov.co/sites/default/files/partes_interesadas0_09.png?fid=201185)
...
El ICBF consciente de la importancia de brindar servicios y atención de calidad, ha identificado las necesidades y expectativas de sus partes interesadas con el fin de fortalecer la gestión, la transparencia y la generación de valor público en la entidad, constituyéndose en un pilar de gran importancia para la planeación estratégica y mejora continua en el marco de nuestro Sistema Integrado de Gestión.

- **Anexo Identificación y Actualización de Necesidades y Expectativas de las Partes Interesadas v3** [Consultar Anexo](https://www.icbf.gov.co/system/files/procesos/a1.p21.de_anexo_identificacion_y_actualizacion_de_necesidades_y_expectativas_de_las_partes_interesadas_v3.pdf "clic para consultar documento")

## Despliegue Plataforma Estratégica ICBF

PLAN NACIONAL DE DESARROLLO 2018 – 2022

![imagen decorativa](https://www.icbf.gov.co/sites/default/files/mpg-arrows_07.png)

[Plan Estratégico Sectorial 2019 - 2022](https://www.icbf.gov.co/system/files/plan_estrategico_sectorial_2020.pdf "consultar documento")

![imagen decorativa](https://www.icbf.gov.co/sites/default/files/mpg-arrows_07.png)

[Plan Indicativo Institucional 2018 - 2022](https://www.icbf.gov.co/sites/default/files/plan_indicativo_2019_-_2022_compressed.pdf "consultar documento")

![imagen decorativa](https://www.icbf.gov.co/sites/default/files/mpg-arrows_07.png)

[Mapa Estratégico 2019 - 2022](https://www.icbf.gov.co/system/files/mapa_estrategico_2020_v2.pdf "consultar documento")

![imagen decorativa](https://www.icbf.gov.co/sites/default/files/mpg-arrows_09.png)

![imagen decorativa](https://www.icbf.gov.co/sites/default/files/mpg-arrows_07.png)

[Plan de Acción ICBF](https://www.icbf.gov.co/planeacion/plan-de-accion "consultar información en portal web")
