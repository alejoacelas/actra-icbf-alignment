---
url: "https://www.icbf.gov.co/aseguramiento-la-calidad-1"
title: "Aseguramiento a la Calidad | Portal ICBF - Instituto Colombiano de Bienestar Familiar ICBF"
---

[![clic para ir a GOVCO](https://www.icbf.gov.co/sites/default/files/logo_header.png)](https://www.gov.co/)

[![ícono de Accesibilidad](https://www.icbf.gov.co/sites/default/files/icon-top_15.png)Accesibilidad](https://www.icbf.gov.co/aseguramiento-la-calidad-1#blocks-links-acc "Haz clic para mostrar las opciones de Accesibilidad")
...
[![icono tamaño](https://www.icbf.gov.co/sites/default/files/icon-access_01.png)](https://www.icbf.gov.co/aseguramiento-la-calidad-1#blocks-links-acc "Clic para mostrar las opciones de Accesibilidad")**Tamaño de Texto**

- [85%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [100%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [125%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [150%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [175%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [200%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)

![icono interlinea](https://www.icbf.gov.co/sites/default/files/icon-access_02.png)**Interlineado**

- [0.5](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [1](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [1.5](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [2](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [2.5](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)

![icono espaciado](https://www.icbf.gov.co/sites/default/files/icon-access_03.png)**Espaciado**

- [90%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [100%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [150%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [200%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [250%](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)

![icono fuente](https://www.icbf.gov.co/sites/default/files/icon-access_04.png)**Fuente**

- [Arial](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [Sans](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [APHont](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [Times](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)

![icono contraste](https://www.icbf.gov.co/sites/default/files/icon-access_05.png)**Contraste**

- [Fondo negro texto blanco](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [Fondo negro texto amarillo](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [Fondo negro texto verde](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
- [Fondo blanco texto negro](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)

[Restaurar valores por defecto](https://www.icbf.gov.co/aseguramiento-la-calidad-1#)
...
2. Aseguramiento A La Calidad


Según el artículo 5 del [Decreto 987 de 2012](http://www.icbf.gov.co/cargues/avance/docs/decreto_0987_2012.htm), las principales funciones de la Oficina de Aseguramiento de la Calidad del ICBF, son: establecer los lineamientos para el otorgamiento, reconocimiento y renovación de personerías jurídicas y licencias de funcionamiento, así como coordinar la ejecución y seguimiento de las acciones de Inspección, Vigilancia y  Control.

De acuerdo con este y con lo establecido en la [Resolución No. 3435 del 20 de abril de 2016](http://www.icbf.gov.co/cargues/avance/docs/resolucion_icbf_3435_2016.htm) en el Articulo 63. PUBLICACIONES, los actos administrativos que otorguen, suspenden, cancelen Personería Jurídica o reconozcan que la entidad pertenece al Sistema Nacional de Bienestar Familiar, así como los que otorguen, renueven, suspendan, cancelen o nieguen licencias de funcionamiento y autorizaciones, serán publicados en este espacio web, dentro de los (15) días hábiles siguientes a la fecha de su ejecutoria.

## Personerías Jurídicas y Licencias de Funcionamiento

### Licencias de Funcionamiento

[Consultar Licencias](https://www.icbf.gov.co/aseguramiento-calidad/licencias-funcionamiento)

Acto Administrativo mediante el cual el ICBF autoriza a una persona jurídica para la prestación de algún programa o modalidad en los servicios de Protección.

### Personería Jurídica

[Consultar Personerías](https://www.icbf.gov.co/aseguramiento-calidad/personerias-juridicas)

Reconocimiento legal del ICBF mediante acto administrativo, de la existencia de una persona ficticia, capaz de ejercer derechos y contraer obligaciones civiles en sus relaciones jurídicas dentro del ámbito del Sistema Nacional de Bienestar Familiar.

## Publicaciones de la Oficina de Aseguramiento a la Calidad

#### Prcoesos Administrativos Sancionatorios

[Consultar Procesos](https://www.icbf.gov.co/aseguramiento-calidad/procesos-administrativos-sancionatorios "clic para más información")

#### Directrices

[Consultar Documntación](https://www.icbf.gov.co/aseguramiento-calidad/directrices "clic para más información")
